  ...
  return (
    ...
    >
      <div className="py-5 flex justify-between items-center">
        {/* Logo */}
        <div className="text-lg font-semibold cursor-pointer dark:text-white text-black">
        ...
        {/* Desktop Menu */}
        <ul className="hidden md:flex space-x-8 text-gray-800 dark:text-gray-300">
          {menuItems.map((item) => (
            <li
              key={item.id}
        ...
        <div className="hidden md:flex items-center space-x-4">
          <a
            href="https://github.com/AkshitMehta2005"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/akshit-mehta-110a60257/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-800 dark:text-gray-300 hover:text-[#8245ec]"
          >
      ...
      {isOpen && (
        <div className="absolute top-16 left-1/2 transform -translate-x-1/2 w-4/5 
                        bg-white/70 dark:bg-[#050414]/70 backdrop-blur-lg 
