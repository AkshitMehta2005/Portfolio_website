          ...
          >
            ...
            >
              ...
              <div className="flex items-center space-x-6">
                {/* School Logo/Image */}
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-white rounded-full flex justify-center items-center shadow-md overflow-hidden">
                  <img
                    src={edu.img}
                    alt={edu.school}
                ...
                <div className="flex flex-col justify-center">
                  <div>
                    ...
                    <h4 className="text-md sm:text-base text-gray-300 mt-1">
                      {edu.school}
                    </h4>
                  </div>
                  {/* Date */}
